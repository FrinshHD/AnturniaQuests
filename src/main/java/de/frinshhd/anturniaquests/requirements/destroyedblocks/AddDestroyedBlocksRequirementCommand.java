...
public class AddDestroyedBlocksRequirementCommand extends BasicSubCommand {
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        ...
        ChatManager.sendMessage(sender, TranslationManager.getInstance().build("quests.command.edit.add.requirement.destroyedBlocks", new Translatable("questID", questID), new Translatable("amount", String.valueOf(destroyedBlocksModel.getAmount())), new Translatable("material", destroyedBlocksModel.getDisplayName())));
        return true;
    }
