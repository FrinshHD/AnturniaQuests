...
public class SetMaterialCommand extends BasicSubCommand {
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        ...
        ChatManager.sendMessage(sender, TranslationManager.getInstance().build("quest.command.edit.set.material", new Translatable("questID", questID), new Translatable("material", material.toUpperCase())));
        return true;
    }
